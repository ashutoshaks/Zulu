...
INSERT INTO `items` (`item_uid`, `type`, `price`, `quantity`, `day_sale`, `total_sale`, `manufacturer_uid`, `vehicle_type`, `start_date`) VALUES (1, 'tyre', 25.50, 5, 6, 4, 1, 'cycle', '2021-10-03');
...
INSERT INTO `items` (`item_uid`, `type`, `price`, `quantity`, `day_sale`, `total_sale`, `manufacturer_uid`, `vehicle_type`, `start_date`) VALUES (6, 'tyre', 621662.22, 7, 886, 86, 1, 'bike', '2021-10-03');